...
public class GarminService implements ApplicationListener<ParticipantUpdateEvent> {
    ...
    private final static String GARMIN_OBSERVATION_TYPE_PATTERN = "garmin-%-observation";
    ...
    private Map<UserAccessTokenWithData, List<ParticipantWithObservationProperties>> getAllGarminParticipants() {
        var participantWithObservationProperties = studyRepository.getParticipantObservationPropertiesByObservationTypeLike(GARMIN_OBSERVATION_TYPE_PATTERN);
