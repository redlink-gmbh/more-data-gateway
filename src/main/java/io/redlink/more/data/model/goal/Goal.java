...
public class Goal {
    ...
    public String getExternalTemplateId() {
        return GoalTemplate.GOAL_TEMPLATE_ID_PREFIX + templateId;
    }
    ...
    public Goal setProperties(Object properties) {
    ...
    public static Integer parseExternalGoalId(String goalId) throws NotFoundException {
        Matcher m = PATTERN_GOAL_ID.matcher(Objects.requireNonNull(goalId));
        if (!m.find()) {
            throw new NotFoundException("Invalid goal ID: " + goalId);
        }
        try {
