...
class ParticipantPortalAuthControllerTest {
    ...
    void testParticipantLoginSetsSession() throws Exception {
        ...
        MvcResult result = mockMvc.perform(post("/api/v1/login/{studyId}/{userDataRef}", studyId, userDataRef)
                        .with(csrf())
    ...
    void testParticipantLoginInvalidBase64() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/login/{studyId}/{userDataRef}", studyId, userDataRef)
                        .with(csrf())
